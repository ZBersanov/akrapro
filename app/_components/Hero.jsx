...
const Hero = () => {
    ...
    <section className="container pt-20">
      <div className="flex justify-between">
        ...
        <div className="mt-[100px] flex-col space-y-6">
            <h1 className="text-[44px] leading-12 font-[700] uppercase">Детейлинг в <br /> Грозном</h1> 
        ...
        <div className="relative flex-col mt-[50px]">
          <div className="absolute z-0 top-0 right-[-200px] w-[400px] h-[200px] bg-[var(--gray)]"></div>
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/bunRtebU7j4?si=FtvxpfQ_Xu1KDs4n" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </div>
        </div>
